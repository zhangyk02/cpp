...
int main()
{
    ...
    read_Mnist_Label("train-labels-idx1-ubyte", trainLabels);
    ...
    read_Mnist_Images("train-images-idx3-ubyte", trainImages);
    cout << trainImages.size() << trainImages[0].size();

    vector<vector<double> > testImages;
    read_Mnist_Images("t10k-images-idx3-ubyte", testImages);
